...
<div class="flex w-full h-full">
  <Sidebar.Provider
    class="!min-h-full h-full w-full flex-1"
                ...
                {#each workspaces as workspace (workspace.id)}
                  <div class="relative flex items-center group/icon">
                    {#if currentWorkspaceId === workspace.id}
                      <div
                        class="absolute h-2/4 border-l-5 border-primary rounded-r-full group-hover/icon:h-3/4 transition-height duration-50"
                      ></div>
                    {/if}
                    ...
                    <Tooltip.Root>
                      <Tooltip.Trigger class="h-full">
                        ...
                        >
                          <Sidebar.MenuButton
                            class="flex items-center justify-center p-2 h-16 w-16 transition-all duration-300 hover:bg-unset focus:bg-unset"
                          >
                            <a
                    ...
                    >
                      <div class="text-center">
                        ...
                        <p class="text-sm mt-2 text-gray-700">
                          Ton espace de travail est l&apos;endroit où tu
                          retrouves tes amis. Crée le tien et lance une
                          discussion.
                        </p>
                      </div>
                    </Dialog.Header>
