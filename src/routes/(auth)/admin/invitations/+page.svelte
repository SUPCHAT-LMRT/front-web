...
<div class="space-y-6">
  ...
  <Card>
    <CardHeader>
      ...
      <div class="flex justify-between items-center">
        <CardDescription
          >Gérez les invitations de votre application</CardDescription
        >
            ...
            <form>
              ...
              {#if createdInviteLink}
                <div class="mt-2 flex flex-col gap-3">
                  <div
                    class="flex items-center justify-between gap-2 p-3 border rounded-md bg-gray-100 dark:bg-gray-700"
                  >
                    <span
          ...
          {#each inviteLinks as invite}
            <TableRow>
              ...
              <TableCell class="text-right">
                <DropdownMenu
                  open={openMenuFor === invite.token}
                  onOpenChange={(opened) =>
                    (openMenuFor = opened ? invite.token : null)}
                >
                  <DropdownMenuTrigger>
  ...
  <AlertDialog.Content>
    <AlertDialog.Header>
      ...
      <AlertDialog.Description>
        Cette action est irréversible.</AlertDialog.Description
      >
    </AlertDialog.Header>
    <AlertDialog.Footer>
