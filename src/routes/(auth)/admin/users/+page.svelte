            ...
            <TableRow>
              <TableCell>
                <Avatar.Root>
                  ...
                  <Avatar.Fallback>
                    <div
                      class="flex items-center justify-center w-full h-full bg-gray-200 text-gray-500 font-bold rounded-full"
                    >
  ...
  <AlertDialog.Content>
    <AlertDialog.Header>
      ...
      <AlertDialog.Description>
        Cette action est irréversible. Vous allez supprimer définitivement cet
        utilisateur.
      </AlertDialog.Description>
    </AlertDialog.Header>
    <AlertDialog.Footer>
      ...
      <AlertDialog.Action
        ...
        class="text-red-500 bg-white border border-gray-200 hover:bg-red-500 hover:text-white dark:hover:bg-red-600 dark:hover:text-white"
      >
        Supprimer
      </AlertDialog.Action>
    </AlertDialog.Footer>
