        ...
        <div class="flex flex-col px-4 py-2">
            <section>
                <div class="flex items-end mb-4">
                    <h1 class="text-3xl font-bold text-gray-700 dark:text-gray-200">Administration</h1>
                ...
                <div>
                    <Tabs.Root value={activeTab.label}>
                        <Tabs.List class="ml-auto dark:bg-gray-900">
                            <Tabs.Trigger value="userList" class="text-gray-600 dark:text-gray-200"
                                          onclick={() => handleTabChange({displayName: "Utilisateurs", label: "userList"}, "/admin/users")}>
                                Utilisateurs
                            </Tabs.Trigger>
                            <Tabs.Trigger value="roles" class="text-gray-600 dark:text-gray-200"
                                          onclick={() => handleTabChange({displayName: "Postes", label: "postes"}, "/admin/postes")}>
                                Postes
                            </Tabs.Trigger>
                            <Tabs.Trigger value="invitation" class="text-gray-600 dark:text-gray-200"
                                          onclick={() => handleTabChange({displayName: "Invitations", label: "invitation"}, "/admin/invitations")}>
                                Invitations
                            </Tabs.Trigger>
                        </Tabs.List>
                    </Tabs.Root>
