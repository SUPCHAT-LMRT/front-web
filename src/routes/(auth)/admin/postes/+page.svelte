      ...
      <CardHeader class="bg-muted/50 rounded-t-xl px-6 py-4">
        <div class="flex items-center gap-3">
          ...
          <CardTitle class="text-lg font-bold tracking-tight"
            >Rôles et Permissions</CardTitle
          >
        </div>
        <CardDescription class="mt-4 text-sm text-muted-foreground space-y-3">
          <div class="flex items-start gap-3">
            ...
            <p class="leading-snug">
              Accès complet incluant la création/suppression d'invitations, la
              gestion des postes, l'attribution des rôles, et l'accès au panneau
              d'administration.
            </p>
          </div>
          <div class="flex items-start gap-3">
            ...
            <p class="leading-snug">
              Accès limité au panneau d'administration et à la création
              d'invitations.
            </p>
          </div>
          <div class="flex items-start gap-3">
            ...
            <p class="leading-snug">
              Rôle organisationnel de base permettant d'identifier la fonction
              de la personne.
            </p>
          </div>
        </CardDescription>
      ...
      <div class="md:col-span-1">
        <Card class="h-full flex flex-col">
          ...
          <CardContent class="flex-grow">
            <JobList bind:selectedJob />
          </CardContent>
          <div class="p-4 flex justify-center items-center flex-grow-0">
            <Button class="text-white w-full" onclick={() => (showModal = true)}
              >Créer un poste</Button
            >
          </div>
        </Card>
      </div>
