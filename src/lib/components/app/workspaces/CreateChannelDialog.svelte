        ...
        {:else if step === 2}
            <div class="space-y-4 max-h-[300px] overflow-y-auto">
                ...
                <div class="flex gap-2 mt-4">
                    <Button onclick={() => step = 1} class="w-full bg-gray-200 text-gray-900 dark:bg-gray-700 dark:text-gray-100">
                        Retour
                    </Button>
                    <Button onclick={handleFinalCreate} class="w-full bg-primary text-white">
                        Créer
                    </Button>
                </div>
            </div>
